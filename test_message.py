...
class TestMessage(unittest.TestCase):
    ...
    def test_concurrent(self):
        ...
        self.assertEqual(t3.next(), (2,(-3,2)))
        # 4 (Scan RT for subsequent)
        self.assertEqual(t2.next(), (4,(2,3)))
        ...
        # 9 (Scan Transition)
        self.assertEqual(t2.next(), (9,(1,2,[(1,2,),(1,4),(2,3)])))
        self.assertEqual(t3.next(), (9,(2,3,[(2,3),(3,4)])))
        # 10:t2 (Delete Transition)
        ...
        self.assertEqual(t2.next(), (8,(1,3,[1,2,3])))
        # 9 (Scan Transition)
        self.assertEqual(t2.next(), (9,(1,2,[(1,2),(2,3)])))
        # 11 (Done)
